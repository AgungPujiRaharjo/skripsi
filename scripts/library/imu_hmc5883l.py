...
rospy.init_node('imu_hmc5883l',anonymous=False)
rate=rospy.Rate(60)
pub=rospy.Publisher('magneto_data',String,queue_size=1)
...
class hmc5883l:
    ...
    def __init__(self, port=1, address=0x1E, gauss=1.3, declination=(0,0)):
        ...
        self.bus.write_byte_data(0x68,0x6a,0x00)
...
if __name__ == "__main__":
    ...
    while not rospy.is_shutdown():
        message=(compass.degrees(compass.heading()))
        string_msg="%i,%i" %(message[0],message[1])
