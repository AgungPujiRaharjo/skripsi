...
class ServoController:
    ...
    def __init__(self):
        self.JOINT = [7,10,12,14,16,18, 8,9,11,13,15,17, 2,4,6, 1,3,5]#[kaki_kiri kaki_kanan tangan_kiri tangan_kanan]
        ...
        self.JOINT_INIT = [372,515,500,523,506,500, 674,518,530,514,515,524, 821,650,600, 207,374,434] 
        ...
        self.present_position = [None] * 18 #awalnya 10
        self.servo_value = []
